...
import pandas as pd
import numpy as np
from utils import add_function, sub_function, mult_function, div_function, log_function,multi_sum_div, power_func
...
operation = st.radio("Choose an operation", ("Addition", "Subtraction", "Multiplication", "Division","Log",'Multi_sum_div',"Power"))
